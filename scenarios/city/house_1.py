...
class House_1:
    ...
    def __init__(self, screen, clock, character):
        ...
        self.background = utils.load_image("background.png", "city/city/house_1")

        self.current_slide = 1
        self.played = [0] * 2
        self.conversation = {
            "1" : utils.load_image("d1.png", "city/city/house_1"),
            "2" : utils.load_image("d2.png", "city/city/house_1")
        }
        self.voices = {
            "1" : utils.load_vx("city/house_1/1.ogg"),
            "2" : utils.load_vx("city/house_1/2.ogg")
        }
        self.visited = False
