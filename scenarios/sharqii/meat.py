...
from scenarios.sharqii import vegetables
from actors.player import Player
from actors.prompt import Prompt

class Meat:
    """
        Class representing the fifth stage of Saar village, recieves
    ...
    def __init__(self, screen, clock, character):
        ...
        self.background = utils.load_image("background.png", "sharqii/meat")
        ...
        self.played = [0] * 8
        self.conversation = {
            "1" : utils.load_image("d1.png", "sharqii/meat/"),
            "2" : utils.load_image("d2.png", "sharqii/meat/"),
            "3" : utils.load_image("d3.png", "sharqii/meat/"),
            "4" : utils.load_image("d4.png", "sharqii/meat/"),
            "5" : utils.load_image("egg1.png", "sharqii/meat/"),
            "6" : utils.load_image("beef.png", "sharqii/meat/"),
            "7" : utils.load_image("egg2.png", "sharqii/meat/"),
            "8" : utils.load_image("key.png", "sharqii/meat/")
        }
        self.voices = {
            "1" : utils.load_vx("sharqii/meat/1.ogg"),
            "2" : utils.load_vx("sharqii/meat/2.ogg"),
            "3" : utils.load_vx("sharqii/meat/3.ogg"),
            "4" : utils.load_vx("sharqii/meat/4.ogg"),
            "5" : utils.load_vx("sharqii/meat/a1.ogg"),
            "6" : utils.load_vx("sharqii/meat/a2.ogg"),
            "7" : utils.load_vx("sharqii/meat/a3.ogg")
        }
        self.biotin = {
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_LEFT or event.key == pygame.K_KP4:
                        ...
                        if self.current_slide == 9:
                            if (self.player.real_x+self.player.rect.width > 1592
                                    and self.player.real_x+self.player.rect.width < 1700):
                                self.current_slide = 5
                                self.visited[0] = True
                            elif (self.player.real_x+self.player.rect.width > 1702
                                  and self.player.real_x+self.player.rect.width < 1838):
                                self.current_slide = 6
                                self.visited[1] = True
                            elif (self.player.real_x+self.player.rect.width > 1872
                                  and self.player.real_x+self.player.rect.width < 2000):
                                self.current_slide = 7
                                self.visited[2] = True
                            elif (self.player.real_x+self.player.rect.width > 120
                                  and self.player.real_x+self.player.rect.width < 266
                                ...
                                veg = vegetables.Vegetables(self.screen, self.clock, self.character)
                                veg.run()
                                del veg
                                running = False
